...
<div class="container-fluid mt-4">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Modifica Servizio</h6>
    </div>
    <div class="card-body">
      ...
      <form action="{{ route('services.update', $service->id) }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="nome_servizio" id="nome_servizio" class="form-control @error('nome_servizio') is-invalid @enderror"
                 value="{{ old('nome_servizio', $service->nome_servizio) }}" required>
          @error('nome_servizio')
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="number" name="prezzo_servizio" id="prezzo_servizio" class="form-control @error('prezzo_servizio') is-invalid @enderror"
                   step="0.01" min="0" value="{{ old('prezzo_servizio', $service->prezzo_servizio) }}">
          </div>
