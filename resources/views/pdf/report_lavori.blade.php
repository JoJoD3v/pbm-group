...
<head>
    <meta charset="UTF-8">
    <title>Report Lavori — {{ \Carbon\Carbon::parse($dataInizio)->format('d/m/Y') }} / {{ \Carbon\Carbon::parse($dataFine)->format('d/m/Y') }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="title">Report Lavori</div>
    ...
    <div class="summary-row">
        ...
        <div class="summary-cell">
            <div class="summary-label">Compensi Incassati</div>
            <div class="summary-value">€ {{ number_format($totaleCompensoPagato, 2, ',', '.') }}</div>
        </div>
        <div class="summary-cell">
    ...
    {{-- Elenco lavori --}}
    <div class="section-title">Elenco Lavori nel Periodo</div>
    @if($lavori->isEmpty())
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($lavoro->workers as $worker)
                                {{ $worker->name_worker }} {{ $worker->cognome_worker }}@if(!$loop->last), @endif
                            @endforeach
                        </td>
                        <td>
                            @php
