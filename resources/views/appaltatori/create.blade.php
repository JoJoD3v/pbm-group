...
<div class="container-fluid mt-4">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Aggiungi Appaltatore</h6>
    </div>
    <div class="card-body">
      @if($errors->any())
      ...
      <form action="{{ route('appaltatori.store') }}" method="POST" id="appaltatoreForm">
        @csrf
        ...
        <div class="mb-3">
          ...
          <div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="tipo_soggetto" id="fisica" value="fisica" checked>
              <label class="form-check-label" for="fisica">Persona Fisica</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="tipo_soggetto" id="giuridica" value="giuridica">
        ...
        <div class="mb-3">
          <input type="hidden" name="latitude_appaltatore" id="latitude" class="form-control" placeholder="Latitudine" >
          <input type="hidden" name="longitude_appaltatore" id="longitude" class="form-control" placeholder="Longitudine" >
        </div>
...
<!-- Script per gestire il toggle dei campi in base al tipo di soggetto (riuso stessa logica dei Clienti) -->
