...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Modifica Pezzo Borderò</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.pezzi-bordero.update', $pezzo->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    ...
                    <input type="text" name="nome_pezzo" id="nome_pezzo"
                           ...
                           value="{{ old('nome_pezzo', $pezzo->nome_pezzo) }}" required>
                    @error('nome_pezzo')
